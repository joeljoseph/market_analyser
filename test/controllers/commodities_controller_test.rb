...
class CommoditiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post commodities_url, params: { commodity: { category: @commodity.category, name: @commodity.name } }
    end
  ...
  test "should update commodity" do
    patch commodity_url(@commodity), params: { commodity: { category: @commodity.category, name: @commodity.name } }
